...
<body>
    ...
    <div class="d-flex">
        ...
        <div class="sidebar collapse d-md-block" id="sidebar">
            <div class="list-group list-group-flush">
                <a href="{{ route('guest') }}" class="profile-home list-group-item list-group-item-action bg-dark text-white"><img src="{{ asset('images/home.png') }}" alt="Home"> Home</a>
                <a href="{{ route('gproyek') }}" class="profile-picture list-group-item list-group-item-action bg-dark text-white"><img src="{{ asset('images/proyek.png') }}" alt="Proyek"> Proyek</a>
                ...
                <a href="{{ route('galatberat') }}" class="profile-alatberat list-group-item list-group-item-action bg-dark text-white"><img src="{{ asset('images/alatberat.png') }}" alt="Alat Berat"> Alat Berat</a>
                <a href="{{ route('gperkakas') }}" class="profile-perkakas list-group-item list-group-item-action bg-dark text-white"><img src="{{ asset('images/perkakas.png') }}" alt="Perkakas"> Perkakas</a>
            </div>
        </div>
        ...
        <div id="page-content-wrapper" class="container-fluid">
            <div class="row mt-3">
                ...
                <p class="card-text">Dashboard dari website</p>
                <a href="{{ route('guest') }}" class="btn btn-primary">Go to Home</a>
            </div>
        </div>
    </div>
   ...
   <div class="col-lg-4 col-md-6 mb-4">
                ...
                <a href="{{ route('gproyek') }}" class="btn btn-primary">Go to Proyek</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-4 col-md-6 mb-4">
                ...
                <a href="{{ route('gmaterial') }}" class="btn btn-primary">Go to Material</a>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
                ...
                <a href="{{ route('galatberat') }}" class="btn btn-primary">Go to Alat Berat</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-4 col-md-6 mb-4">
                ...
                <a href="{{ route('gperkakas') }}" class="btn btn-primary">Go to Perkakas</a>
            </div>
        </div>
    </div>
