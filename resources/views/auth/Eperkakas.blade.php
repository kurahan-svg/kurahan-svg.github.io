    ...
    <div class="d-flex">
       ...
       <div class="page-content">
            ...
            <div class="container-fluid">
                <h3>Edit Perkakas</h3>
                <!-- Content goes here -->
                <form method="POST" action="{{ route('perkakas.update', $Perkakas->id_perkakas) }}) }}">
        @csrf
        <div class="form-group">
            <label for="nama_proyek">Nama Proyek</label>
            <select class="form-control" id="nama_proyek" name="nama_proyek" value="{{ $Perkakas->nama_proyek }}" required>
            ...
            <input type="hidden" id="nama_proyek_hidden" name="nama_proyek_hidden" value="{{ $Perkakas->nama_proyek }}"> <!-- Hidden input for project name -->

            <div class="form-group">
                <label for="id_proyek">ID Proyek</label>
                <input type="text" class="form-control" id="id_proyek" name="id_proyek" value="{{ $Perkakas->id_proyek }}" readonly>
            </div>

        <div class="form-group">
            <label for="material">Nama Perkakas</label>
            <input type="text" class="form-control" id="perkakas" name="perkakas" value="{{ $Perkakas->perkakas }}" required>
        </div>
        <div class="form-group">
            <label for="jumlah_awal">Jumlah</label>
            <input type="number" class="form-control" id="jumlah" name="jumlah" value="{{ $Perkakas->jumlah }}" required>
        </div>
        <div class="form-group">
            <label for="harga">Harga</label>
            <input type="text" class="form-control" id="harga" name="harga" value="{{ $Perkakas->harga }}" required oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
        </div>
        <div class="form-group">
            <label for="jumlah_awal">Kondisi</label>
            <input type="text" class="form-control" id="kondisi" name="kondisi" value="{{ $Perkakas->kondisi }}" required>
        </div>
