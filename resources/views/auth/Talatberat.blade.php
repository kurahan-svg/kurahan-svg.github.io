...
<body>
    ...
    <div class="d-flex">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="material" name="alatberat" required>
        </div>
        <div class="form-group">
            <label for="jumlah_awal">Jumlah</label>
            <input type="number" class="form-control" id="jumlah_awal" name="jumlah" required>
        </div>
        <div class="form-group">
            <label for="jumlah_awal">Usia(tahun)</label>
            <input type="number" class="form-control" id="jumlah_awal" name="usia" >
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="jumlah_awal" name="kondisi" required>
        </div>
        <div class="form-group">
            <label for="jumlah_awal">Penempatan</label>
            <input type="text" class="form-control" id="jumlah_awal" name="penempatan" required>
        </div>
        <div class="form-group">
