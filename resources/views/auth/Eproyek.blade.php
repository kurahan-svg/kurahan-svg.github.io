    ...
    <div class="d-flex">
        ...
        @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="lokasi" name="lokasi"  value="{{ $proyek->lokasi }}" required>
                    </div>
                    <div class="form-group">
                        <label for="tanggal_mulai">Tanggal Mulai</label>
                        <input type="date" class="form-control" id="tanggal_mulai" name="tanggal_mulai" value="{{ $proyek->tanggal_mulai }}" required>
                    </div>
                    <div class="form-group">
                        <label for="tanggal_selesai">Tanggal Selesai</label>
                        <input type="date" class="form-control" id="tanggal_selesai" name="tanggal_selesai" value="{{ $proyek->tanggal_selesai }}" required>
                    </div>
