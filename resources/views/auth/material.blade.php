...
<body>
    ...
    <div class="topbar d-flex justify-content-between align-items-center">
        ...
        <!-- Form Pencarian -->
        <form class="ms-auto" action="{{ route('cariM') }}" method="GET">
    ...
    <div class="d-flex">
        ...
        <div class="page-content">
            ...
            <tr>
                ...
                <th>Created At</th>
                <th>Updated At</th>
                <th><a href="{{ route('Tmaterial') }}" class="btn btn-primary">Tambah Material</a></th>
            </tr>
        </thead>
        <tbody>
        @foreach ($materials as $material)
                <tr>
                    <td>{{ $material->id_proyek }}</td>
                    <td>{{ $material->nama_proyek }}</td>
                    <td>{{ $material->id_material }}</td>
                    <td>{{ $material->material }}</td>
                    <td>{{ $material->jumlah_awal }}</td>
                    <td>{{ $material->harga }}</td>
                    <td>{{ $material->jumlah_akhir }}</td>
                    <td>{{ $material->created_at }}</td>
                    <td>{{ $material->updated_at }}</td>
                    <td><a href="{{ route('Ematerial', ['id_material' => $material->id_material]) }}" class="btn btn-warning">Edit</a>
                        <a href="{{ route('Dmaterial', ['id_material' => $material->id_material]) }}" class="btn btn-danger">Delete</a>
                </td>
                </tr>
            @endforeach
        </tbody>
