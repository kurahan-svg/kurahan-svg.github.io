    ...
    <div class="d-flex">
       ...
       <div class="page-content">
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="nama_proyek" name="nama_proyek" value="{{ $material->nama_proyek }}" required>
            ...
            <input type="hidden" id="nama_proyek_hidden" name="nama_proyek_hidden" value="{{ $material->nama_proyek }}" > <!-- Hidden input for project name -->

            <div class="form-group">
                <label for="id_proyek">ID Proyek</label>
                <input type="text" class="form-control" id="id_proyek" name="id_proyek" value="{{ $material->id_proyek }}"  readonly>
            </div>
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="jumlah_awal" name="jumlah_awal" value="{{ $material->jumlah_awal }}" required>
        </div>
        <div class="form-group">
            <label for="harga">Harga</label>
            <input type="text" class="form-control" id="harga" name="harga" value="{{ $material->harga }}" required oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
        </div>
        <div class="form-group">
            <label for="jumlah_awal">Jumlah Akhir</label>
            <input type="number" class="form-control" id="jumlah_awal" name="jumlah_akhir" value="{{ $material->jumlah_akhir }}" required>
        </div>
        <div class="form-group">
