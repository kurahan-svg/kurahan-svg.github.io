...
<body>
    ...
    <div class="topbar d-flex justify-content-between align-items-center">
        ...
        <!-- Form Pencarian -->
        <form class="ms-auto" action="{{ route('cariA') }}" method="GET">
    ...
    <div class="d-flex">
        ...
        <thead>
            <tr>
                ...
                <th>Created At</th>
                <th>Updated At</th>
                <th><a href="{{ route('Talatberat') }}" class="btn btn-primary">Tambah Alat Berat</a></th>
            </tr>
        </thead>
        <tbody>
        @foreach ($Alatberat as $Alatberat)
                <tr>
                    <td>{{ $Alatberat->id_proyek }}</td>
                    <td>{{ $Alatberat->nama_proyek }}</td>
                    <td>{{ $Alatberat->id_alatberat }}</td>
                    <td>{{ $Alatberat->alatberat }}</td>
                    <td>{{ $Alatberat->jumlah }}</td>
                    <td>{{ $Alatberat->usia }}</td>
                    <td>{{ $Alatberat->harga }}</td>
                    <td>{{ $Alatberat->kondisi }}</td>
                    <td>{{ $Alatberat->penempatan }}</td>
                    <td>{{ $Alatberat->created_at }}</td>
                    <td>{{ $Alatberat->updated_at }}</td>
                    <td><a href="{{ route('Ealatberat', ['id_alatberat' => $Alatberat->id_alatberat]) }}" class="btn btn-warning">Edit</a>
                        <a href="{{ route('Dalatberat', ['id_alatberat' => $Alatberat->id_alatberat]) }}" class="btn btn-danger">Delete</a>
                </td>
                </tr>
            @endforeach
        </tbody>
