...
<body>
    ...
    <div class="topbar d-flex justify-content-between align-items-center">
        ...
        <!-- Form Pencarian -->
        <form class="ms-auto" action="{{ route('cariproyek') }}" method="GET">
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th><a href="{{ route('Tproyek') }}" class="btn btn-primary">Tambah Proyek</a></th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('Eproyek', ['id_proyek' => $proyek->id_proyek]) }}" class="btn btn-warning">Edit</a>
                            <a href="{{ route('Dproyek', ['id_proyek' => $proyek->id_proyek]) }}" class="btn btn-danger">Delete</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
            <a href="{{ route('home') }}" class="btn btn-danger">Download</a>
        </div>
    </div>
    ...
    <!-- Script to handle success and error alerts -->
    <script>
